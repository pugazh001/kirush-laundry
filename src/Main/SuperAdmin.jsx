      ...
      <div className='flex'>
        ...
        <div className='grow ml-16 md:ml-64 h-full lg:h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white'>
          ...
          <div>
            ...
            {activeComponent === 'dashboards' && <Dashboard triggerRefresh={triggerRefresh} refresh={refresh} />}
            {activeComponent === 'dashboard' && <SuperAdminPage triggerRefresh={triggerRefresh} refresh={refresh} />}
