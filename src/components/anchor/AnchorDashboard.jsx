...
const AnchorDashboard = ({ triggerRefresh, refresh }) => {
...
const options = {
  ...
  return (
    <div className='grow p-8'>
      ...
      /> */}
      <h2 className='text-2xl mb-4' style={{marginTop:"25px"}} > {user.user_Name} Dashboard <span style={{color:"blue"}}>(Delivery Associate)</span></h2>
    </div>
...
<Card 
  icon={<FaTicketAlt />} 
  title="My Orders" 
  value={<CountUp end={orders.length} duration={2} />} 
  style={{ backgroundColor: 'rgba(255, 247, 240, 0.8)' }} 
/>
<Card 
  icon={<FaTicketAlt />} 
